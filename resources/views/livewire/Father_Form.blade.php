            ...
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select my-1 mr-sm-2" wire:model.lazy="Nationality_Father_id">
                    ...
                    <div class="form-group col">
                        ...
                        <select class="custom-select my-1 mr-sm-2" wire:model.lazy="Blood_Type_Father_id">
                            <option selected>{{trans('Parent_trans.Choose')}}...</option>
                    ...
                    <div class="form-group col">
                        ...
                        <select class="custom-select my-1 mr-sm-2" wire:model.lazy="Religion_Father_id">
                            <option selected>{{trans('Parent_trans.Choose')}}...</option>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" wire:model.lazy="Address_Father" id="exampleFormControlTextarea1" rows="4"></textarea>

            ...
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <input type="text" wire:model.lazy="Name_Mother" class="form-control">
                        @error('Name_Mother')
                    ...
                    <div class="col">
                        ...
                        <input type="text" wire:model.lazy="Name_Mother_en" class="form-control">
                ...
                <div class="form-row">
                    <div class="col-md-3">
                        ...
                        <input type="text" wire:model.lazy="Job_Mother" class="form-control">
                        @error('Job_Mother')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="text" wire:model.lazy="Job_Mother_en" class="form-control">
                        @error('Job_Mother_en')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col">
                        ...
                        <input type="text" wire:model.lazy="National_ID_Mother" class="form-control">
                    ...
                    <div class="col">
                        ...
                        <input type="text" wire:model.lazy="Passport_ID_Mother" class="form-control">
                    ...
                    <div class="col">
                        ...
                        <input type="text" wire:model.lazy="Phone_Mother" class="form-control">
                        @error('Phone_Mother')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select my-1 mr-sm-2" wire:model.lazy="Nationality_Mother_id">
                    ...
                    <div class="form-group col">
                        ...
                        <select class="custom-select my-1 mr-sm-2" wire:model.lazy="Blood_Type_Mother_id">
                            <option selected>{{trans('Parent_trans.Choose')}}...</option>
                    ...
                    <div class="form-group col">
                        ...
                        <select class="custom-select my-1 mr-sm-2" wire:model.lazy="Religion_Mother_id">
                            <option selected>{{trans('Parent_trans.Choose')}}...</option>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" wire:model.lazy="Address_Mother" id="exampleFormControlTextarea1"
                              rows="4"></textarea>

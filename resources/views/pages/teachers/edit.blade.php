                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="nameAr" value="{{ $Teachers->getTranslation('name', 'ar') }}" class="form-control">
                                    @error('Name_ar')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col">
                                    ...
                                    <input type="text" name="nameEn" value="{{ $Teachers->getTranslation('name', 'en') }}" class="form-control">
                                    @error('Name_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <div class='input-group date'>
                                        <input class="form-control" type="text"  id="datepicker-action"  value="{{$Teachers->joiningDate}}" name="joiningDate" data-date-format="yyyy-mm-dd"  required>
                                    </div>
                                    @error('Joining_Date')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('sections.submit')}}</button>
                    </form>
                        </div>
                    </div>
                </div>
